...
def generate_launch_description():
    ...
    world = os.path.join(my_custom_launch_file_dir, 'aruco.world')

    os.environ["GAZEBO_MODEL_PATH"] = os.path.join(my_custom_launch_file_dir, "") + ":" + os.environ.get("GAZEBO_MODEL_PATH", "")
